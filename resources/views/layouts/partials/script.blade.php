...
<!-- <script src="{{ asset('/MultiDatesPicker/jquery-ui.multidatespicker.js') }}"></script>
<script src="{{ asset('/MultiDatesPicker/jquery-ui.multidatespicker.js') }}"></script>
<script src="{{ asset('/MultiDatesPicker/js/prettify.js') }}"></script>
<script src="{{ asset('/MultiDatesPicker/js/lang-css.js') }}"></script> -->
<!-- <script src="https://code.jquery.com/jquery-1.12.4.js"></script>
<script src="http://multidatespickr.sourceforge.net/js/jquery-1.11.1.js"></script>
<script src="http://multidatespickr.sourceforge.net/js/jquery-ui-1.11.1.js"></script>
<script src="http://multidatespickr.sourceforge.net/js/jquery-2.1.1.js"></script>
<script src="http://multidatespickr.sourceforge.net/jquery-ui.multidatespicker.js"></script>
 -->
<!-- PAGE RELATED PLUGIN(S) -->
<script src="{{ asset('admin/js/SmartNotification.js') }}"></script>

<script src="{{asset('/sa/js/plugin/bootstrap-wizard/jquery.bootstrap.wizard.min.js')}}"></script>
<script src="{{asset('/sa/js/plugin/fuelux/wizard/wizard.min.js')}}"></script>
