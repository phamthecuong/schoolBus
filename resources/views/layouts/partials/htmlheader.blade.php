...
<title>@yield("html_title", "School Bus")</title>
...
<!-- <link rel="stylesheet" type="text/css" media="screen" href="{{ asset('/MultiDatesPicker/css/jquery-ui.css') }}">
<link rel="stylesheet" type="text/css" media="screen" href="{{ asset('/MultiDatesPicker/css/jquery-ui.structure.css') }}">
<link rel="stylesheet" type="text/css" media="screen" href="{{ asset('/MultiDatesPicker/css/pepper-ginder-custom.css') }}">
<link rel="stylesheet" type="text/css" media="screen" href="{{ asset('/MultiDatesPicker/css/prettify.css') }}"> -->
