...
<html lang="en-us" id="extr-page">
    ...
    <body id="login">
        ...
        <header id="header">
            <div id="logo-group">
                <span id="logo">TIS</span>
            </div>

            <span id="extr-page-header-space">
                <span class="hidden-mobile hiddex-xs">{{ trans('auth.register.alreadyregistered')}}</span>
                <a href="{{ url('login') }}" class="btn btn-danger">{{ trans('auth.register.signin')}}</a>
            </span>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7 hidden-xs hidden-sm">
                        ...
                        <div class="hero">
                            ...
                            <img src="{{ asset('sa/img/demo/iphoneview.png') }}" alt="" class="pull-right display-image" style="width:210px">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5">
                        <div class="well no-padding">
                            ...
                            <form id="smart-form-register" class="smart-form client-form" method="POST" action="{{ url('/register') }}">
                                <header>
                                    {{ trans('auth.register.register_box.title')}}
                                </header>
