...
class NewsController extends Controller
{
    ...
    public function store(NewsRequest $request)
    {
        ...
        try
        {
            ...
            $news->created_by = $id;
            //$news->updated_by = Auth::user()->profile_id;
            $news->save();
            DB::commit();
            return redirect(url('school/news'))->with(['flash_level'=>'success','flash_message'=>trans('general.success_add')]);       
    ...
    public function update(NewsRequest $request, $id)
    {
        ...
        try
        {
            ...
            $news->save();
            DB::commit();
            return redirect(url('school/news'))->with(['flash_level'=>'success','flash_message'=>trans('general.success_edit')]);        
        }
       catch (\Exception $e)
       {
            DB::rollBack();
    ...
    public function destroy($id)
    {
        ...
        {   
            ...
            $news->delete();
            DB::commit();
            return redirect(url('school/news'))->with(['flash_level'=>'success','flash_message'=>trans('general.success_delete')]);        
        }
        catch(\Exception $e)
        {
            DB::rollBack();
